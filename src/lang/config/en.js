module.exports = {
  ...
  wtrx: {
    ...
    wtitn: 'WTRX is a TRC20 Token, you can swap to any other TRC20 Tokens on LPC.',
  ...
  Stake: {
    ...
    sfox: 'To stake LPC_LP tokens, acquire',
    stfe: 'Total LPC Earned',
    syuf: 'Your Unstaked LPC_LP',
    sysfl: 'Your Staked LPC_LP',
  ...
  fox: {
    ...
    fb1: 'What is LPC.Finance?',
    fb2: 'LPC.finance is a DEX protocol to exchange TRC-20 tokens on TRON. It requires no trusted intermediaries or unnecessary forms of commission, thus enabling fast and efficient transactions. Advantages include decentralization, censorship resistance and safety. DEX is anopen source software under GPL.',
    ...
    fdd: 'What is LPC？',
    fd4: 'LPC is the protocol token that empowers the token economy for the DEX platform. In addition, it is also the governance token for voting on proposals.Protocol fee will be used in full to repurchase and burn, as well as add liquidity for LPC. This will be open to users who meet certain conditions, enabling a transparent system.',
    fd5: '● The total supply of LPC is 31 million. A new block is generated about every 3 seconds and 3 Bees are registered in one block. Thus 86,400 Bees are issued per day and will be reduced by 2% every week.',
    fd6: '● LPC will be used to incentivize trading pairs that meet certain conditions on the DEX.',

    fe1: '2.1 LPC Security',
    fe2: 'Security lies in two aspects. The first is the smart contract security of the DEX and the other is to ensure that the team will always do the right thing.',
    fe3: '2.1.1 The security of the smart contract',
    fe4: 'It has been audited by KnownSec. ',
    ...
    ff2: 'The great significance of smart contracts is to ensure that no one will be evil during the cooperation of two or more parties. And never test humanity by money. ',
    ff3: '● In the DEX contract, users will be responsible for their own assets. The contract only provides functions such as trading, liquidity creation, liquidity addition and withdrawal, and the contract does not have the right to use or manage users’ assets.',
    ff4: '● No one has the right to withdraw assets from the fee address, and it only provides the operation interface to repurchase and burn,as well as add liquidity for LPC. Users who meet certain conditions can execute it. '
  ...
  homelang2: 'Swap TRC-USDT on LuckySwap',
  ...
  homelang7: 'LuckySwap supports the addition of USDT liquidity, USDT trading pairs can be created.',
  ...
  homelang20: '',
  homelang21: '',
  lang1: 'Deposit LPC token for 200% revenue',
  lang2: 'My LPC Balance',
  ...
  lang8: 'statistics',
  lang9: 'Total number of LPC deposited',
  lang10: 'Total amount of LPC withdrawn',
